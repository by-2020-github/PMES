...
public class FSqlMysqlHelper
{
    private readonly ILogger _logger;
    public IFreeSql FSql { get; }


    public FSqlMysqlHelper(ILogger logger, string? connStr = null)
    {
        _logger = logger;
        FSql = new FreeSqlBuilder()
            ...
            .UseConnectionString(DataType.MySql, connStr ?? PMESConfig.Default.ConnLocalMysql)
