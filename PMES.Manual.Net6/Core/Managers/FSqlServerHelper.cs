...
public class FSqlServerHelper
{
    private readonly ILogger _logger;
    public IFreeSql FSql { get; }

    public FSqlServerHelper(ILogger logger, string? connStr = null)
    {
        _logger = logger;
        FSql = new FreeSqlBuilder()
            ...
            .UseConnectionString(DataType.SqlServer, connStr , typeof(FreeSql.SqlServer.SqlServerProvider<>))
